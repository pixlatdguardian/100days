...
def game():
    ...
    while correct:
        print(
            f"Compare A: {data[option_a]['name']}, a {data[option_a]['description']}, from {data[option_a]['country']}.")
        print(art.vs)
        print(
            f"Against B: {data[option_b]['name']}, a {data[option_b]['description']}, from {data[option_b]['country']}.")
